...
<div class="sellerProfileContainer">
    ...
    <!-- Modal 7 Languages Modal -->
    <div class="overlayLanguages" id="overlayLanguages">
        ...
        <div class="modalLanguages" id="ModalLanguages">
            ...
            <form id="profileDeleteForm" method="post" action="./sellerProfile/deleteSellerProfile">
                ...
                <div class="buttons">
                    ...
                    <button type="button" onclick="confirmActionAddLan('Cancel')">Cancel</button>
                    <button type="button" onclick="confirmActionAddLan('Add')">Add Languages</button>
    ...
    <!-- Modal 5 Cancel Adding Languages -->
    <div class="overlayLanguages" id="cancelConfirmationOverlay1">
        ...
        <div class="confirmation" id="cancelConfirmation1">
            ...
            <div class="buttons">
                ...
                <button onclick="handleConfirmationAddLan('cancelAddLanNo')">No</button>
                <button onclick="handleConfirmationAddLan('cancelAddLanYes')">Yes</button>
                ...
                <div class="description">
                    ...
                    <div class="profileAdditionals">
                        ...
                        <div >
                            ...
                            <a href=""><button class="addButton" onclick="addLanguages(this)">Add</button></a>
