...
(13, 'dfdfdfd', 'dfdfddf', 'Graphics & Design', 'freshhack final round.jpg', 0, '2024-01-25 22:47:40', 'InActive', 3),
(14, 'erydyyyyyee', 'eryeryyeeeyr', 'Graphics & Design', 'Screenshot 2023-08-05 113344.png', 0, '2024-01-26 00:49:45', 'InActive', 3),
...
INSERT INTO `orders` (`order_id`, `order_status`, `order_type`, `order_created_date`, `buyer_id`, `seller_id`) VALUES
(1, NULL, NULL, '2024-01-26 15:54:51', 1, 3),
(3, 'request', 'package', '2024-01-26 22:12:55', 1, 3),
(4, 'request', 'package', '2024-01-26 21:14:17', 1, 3),
(5, 'request', 'package', '0000-00-00 00:00:00', 1, 3),
(6, 'request', 'package', '2024-01-26 21:16:45', 1, 3),
...
(4, 'Basic', 100, 1, 'Days', '1', 'dfdf', '2024-01-25 22:47:40', 13),
(5, 'Standard', 200, 2, 'Days', '1', 'dfdfdfdfd', '2024-01-25 22:47:40', 13),
(6, 'Premium', 300, 1, 'Days', '1', 'dfdffdfd', '2024-01-25 22:47:40', 13),
(7, 'Basic', 100, 1, 'Days', '1', 'eyreyeyeer', '2024-01-26 00:49:45', 14),
(8, 'Standard', 200, 1, 'Days', '1', 'eryeyeyer', '2024-01-26 00:49:45', 14),
(9, 'Premium', 300, 1, 'Days', '1', 'eryeyeyee', '2024-01-26 00:49:45', 14),
...
--
ALTER TABLE `gigs`
  MODIFY `gig_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `jobs`
  MODIFY `job_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `packages`
  MODIFY `package_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
