...
function openModal(button) {
  ...
  if (orderType === 'packageOrder') {
    let packageModals = document.getElementsByName('packageModal');
    document.getElementById('packageOverlay').style.display = 'flex';

    if (packageModals.length > 0) {
      packageModals[0].style.display = 'block';
    } else {
      console.error('No packageModals found');
    }
  
  } else {

    let milestoneModals = document.getElementsByName('milestoneModal');
    document.getElementById('milestoneOverlay').style.display = 'flex';

    if (milestoneModals.length > 0) {
      milestoneModals[0].style.display = 'block';
    } else {
      console.error('No milestoneModals found');
    }
